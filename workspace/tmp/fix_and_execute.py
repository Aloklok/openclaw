...
def fix_date_format(date_str):
    ...
    # Remove microseconds and format correctly
...
def execute_reorganization():
    ...
    for task in learning_tasks:
        ...
        cmd = f'npx dida365 task update {task["id"]} --startDate "{start_date_fixed}" --dueDate "{due_date_fixed}" --priority 5'
    ...
    for task in project_tasks:
        ...
        cmd = f'npx dida365 task update {task["id"]} --startDate "{start_date_fixed}" --dueDate "{due_date_fixed}" --priority 3'
    ...
    for task in maintenance_tasks:
        ...
        cmd = f'npx dida365 task update {task["id"]} --startDate "{start_date_fixed}" --dueDate "{due_date_fixed}" --priority 1'
